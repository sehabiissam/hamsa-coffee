...
import { Mail, Phone, MapPin, Clock, ArrowRight, Check, Sparkles, Send } from 'lucide-react';
  ...
  const contactOptions = [
    {
      icon: MapPin,
      title: 'Our Sanctuary',
      detail1: '12 Rue Didouche Mourad',
    ...
    },
    {
      ...
      detail1: '+213 (0) 550 12 34 56',
      detail2: '+213 (0) 21 73 45 61',
      actionLabel: 'Call Front Desk',
      link: 'tel:+213550123456',
    },
    {
      icon: Mail,
