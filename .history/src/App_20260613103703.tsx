...
export default function App() {
  ...
  const [experienceSelection, setExperienceSelection] = useState<'standard' | 'high_tea' | 'oasis_tasting'>('standard');

  const triggerReservation = (exp: 'standard' | 'high_tea' | 'oasis_tasting' = 'standard') => {
    setExperienceSelection(exp);
