          ...
          <div className="lg:col-span-12 space-y-8">
            ...
            <div className="w-full h-[300px] md:h-[400px] border border-sand/40 overflow-hidden shadow-md">
              <iframe
                ...
                title="Hamsa Coffee & Brunch Location"
              />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <a
                href="tel:0542734809"
                className="flex items-center justify-center gap-2 p-4 bg-espresso hover:bg-gold text-cream hover:text-espresso rounded-none border border-espresso smooth-transition font-mono text-xs tracking-widest uppercase font-bold"
              >
                <Phone className="w-4 h-4" />
                Call Now
              </a>
              <a
                href="https://www.google.com/maps/place/Hamsa+Coffee%26brunch/@36.1618298,1.3283749,36m/data=!3m1!1e3!4m14!1m7!3m6!1s0x12840f6ff339c8c9:0x4734359a9adc67ae!2sHamsa+Coffee%26brunch!8m2!3d36.1618602!4d1.3284987!16s%2Fg%2F11z6vg59db!3m5!1s0x12840f6ff339c8c9:0x4734359a9adc67ae!8m2!3d36.1618602!4d1.3284987!16s%2Fg%2F11z6vg59db"
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 p-4 bg-espresso hover:bg-gold text-cream hover:text-espresso rounded-none border border-espresso smooth-transition font-mono text-xs tracking-widest uppercase font-bold"
              >
